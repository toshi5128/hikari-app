...
const STATIC_ASSETS = ["manifest.json", "sw.js", "icon-192.png", "icon-512.png", "logo-full.png", "logo-mark.png", "jiage-baikyaku-teian.pdf", "satei-proposal-template.html", "satei-hinagata-template.html"];
let copiedCount = 0;
